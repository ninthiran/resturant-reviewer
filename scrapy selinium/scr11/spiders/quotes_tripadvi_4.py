# -*- coding: utf-8 -*-
"""
Created on Fri Jun 29 11:28:59 2018
...
class QuotesTripadvir(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        time.sleep(5)
        rating_5 = self.driver.find_element_by_id('taplc_location_review_filter_controls_0_filterRating_4')
        rating_5.click()
        time.sleep(2)
