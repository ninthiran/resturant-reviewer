# -*- coding: utf-8 -*-
"""
Created on Fri Jun 29 11:39:05 2018
...
class QuotesTripadvir(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        time.sleep(5)
        rating_3 = self.driver.find_element_by_id('taplc_location_review_filter_controls_0_filterRating_3')
        rating_3.click()
        time.sleep(2)
